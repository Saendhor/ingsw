...
public class Test {
    public static void main(String[] args) {
        ...
        //funzione lambda come comparatore direttamente nel sort -- notare l'inversione dell'ordinamento
        Collections.sort(footballTeam, (Player pl1, Player pl2) -> Integer.compare(pl2.getAge(), pl1.getAge()));
        System.out.println("After Sorting : " + footballTeam);

        //comparatore istanziato sul natural ordering di una chiave di player
